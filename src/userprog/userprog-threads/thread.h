...
struct thread
  {
    ...
    int nice;
    uint32_t recent_cpu;
    struct semaphore load_sema;        /* semaphore to sync process_execute */
    struct semaphore wait_sema;        /* semaphore to sync process_wait*/
    struct semaphore exit_sema;
    struct thread *parent;
    bool load_success;                 /* check if thread loaded successfully */
    bool waited;                       /* check if a process is already waiting for thread */
    int exit_status;                
